...
public class ResourceXmlClientTestCase 
{
   ...
   {
      return ShrinkWrap.create(WebArchive.class).addClass(TestServlet.class);
   }

   @Test
   public void shouldBeAbleToDeployWebArchive(@ArquillianResource(TestServlet.class) URL baseURL) throws Exception
   {
